...
export default {
  ...
  getAcessForQuestion:userService.getAcessForQuestion,
  ...
  getAllAccessList: userService.getAllAccessList,
  giveAccess: userService.giveAccess,
  revokeAccess: userService.revokeAccess,
  deleteAccess:userService.deleteAccess,
  //folder
  getParentFolder:userService.getParentFolder,
  getSubFolder:userService.getSubFolder,
