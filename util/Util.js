...
async function sendPasswordReset(to_mail,user_name,link)
{
	...
	let body="<p>Hai "+user_name+",</p>\
	 		<p>A request has been recevied to change the password for your Scrutiny account. This link only work for 20 minutes</p>\
...
async function verfiyMail(to_mail,user_name,link){
	...
	let body="<p>Hai "+user_name+",</p>\
	 		<p>we're happy you signed up for Scrutiny. To start exploring the Scrutiny confirm your email address\
